...
@section('content')
    <div class="main-content container-fluid">
        ...
        <div class="page-title">
            ...
            <p class="text-subtitle text-muted">Anda dapat melihat riwayat layanan pendampingan yang diterima, ditolak maupun pengajuan 
                        ...
                        <tbody>
                            @foreach ($p as $no => $item)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{url('detail-riwayat-layanan-pendampingan/'.$item->id)}}" class="btn btn-sm btn-outline-primary">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
