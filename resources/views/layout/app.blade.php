                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @if ($user->role == 'users')
                            ...
                            <li class="sidebar-item {{ request()->is('landing-page*') ? 'active' : '' }}">
                        ...
                        <li class="dropdown nav-icon">
                            <a href="#" data-toggle="dropdown"
                                ...
                                <div class="d-lg-inline-block">
                                    <i data-feather="bell"></i>@if ($user->role == 'admin')
                                    <sup>{{$kta + $pta}}
                                    </sup>
                                    @else
                                    <sup>{{$ktu + $jtu + $ptu}}</sup>
                                    ...
                                    <h6 class='py-2 px-4'>Konsultasi</h6>
                                        ...
                                        @foreach ($pend as $p)
                                            <a href="{{ route('pendampingan.notifikasi', $p->id) }}"
                                                ...
                                                <div class="col-sm-12 p-3">
                                                    <small><b>{{ $p->judul_permohonan }}</b></small> -
                                                    <small>{{ $p->kategori_masalah }}</small>
                                    ...
                                    @else
                                        ...
                                        @foreach ($ju as $p)
                                            <a href="{{ route('pendampingan.notifikasi', $p->id) }}"
                                                ...
                                                <div class="col-sm-12 p-3">
                                                    <small><b>{{ $p->nama_kegiatan }}</b></small> -
                                                    {{-- <small>{{ $p->kategori_masalah }}</small> --}}
                                                    <small>({{ date('d/M/Y', strtotime($p->created_at)) }})</small>
                                                </div>
                                            </a>
                            ...
                            <a href="#" data-toggle="dropdown"
                                ...
                                <div class="avatar mr-1">
                                    @if ($user->foto_profil == null)
                                        <img src="{{ asset('images/avatar/avatar-s-1.png') }}" alt=""
                                            srcset="" style="object-fit:cover;">
                                    @else
                                        <img src="{{ url('/photos/' . $user->foto_profil) }}" alt=""
                                            srcset="" style="object-fit:cover;">
                                    @endif
                                </div>
                                <div class="d-none d-md-block d-lg-inline-block">Hi, {{ AUTH::user()->first_name }}
