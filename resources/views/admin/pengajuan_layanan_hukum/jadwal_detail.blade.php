        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mt-3">
                        <div class="col-sm-3">
                            <strong>Judul Permohonan</strong>
                        </div>
                        ...
                        <div class="col-sm-8">
                            @if ($p->jadwal->id == null)
                                        <p><i class="fas fa-xmark text-danger"></i>&nbsp; Belum ada jadwal</p>
                                    @else
                                        <p><i class="fas fa-check text-success"></i>&nbsp; Sudah ada jadwal</p>
    ...
    <div class="modal fade text-left" id="default2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        Apakah anda yakin ingin menolak Jadwal Pendampingan dengan judul permohonan
                        <b>{{ $p->judul_permohonan }} - {{ $p->kategori_masalah }}</b>
                    </p>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1" class="form-label">Catatan</label>
